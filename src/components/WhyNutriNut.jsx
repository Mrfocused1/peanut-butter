...
import iconPalmOil from '../assets/icon-palmoil.webp'
import iconFillers from '../assets/icon-fillers.webp'
import iconPreservatives from '../assets/icon-preservatives.webp'
